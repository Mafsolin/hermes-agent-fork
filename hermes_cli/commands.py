...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("tokens", "Show token usage and rate limits; `reset` redeems a banked Codex limit reset", "Info",
               aliases=("usage",), args_hint="[reset [--force]]"),
    CommandDef("limits", "Show configured API provider limits", "Info"),
